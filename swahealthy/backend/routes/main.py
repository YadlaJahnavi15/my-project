...
def wellness_chat():
    ...
    crisis_keywords = [
        ...
        'ఆత్మహత్య', 'నన్ను నేను చంపుకుంటాను', 'నా జీవితాన్ని ముగించుకుంటాను', 'చావాలని ఉంది', 'బ్రతకడానికి కారణం లేదు', 'చనిపోతేనే మేలు'
    ]
    ...
    distress_words = [
        ...
        'ఆశ లేకపోవడం', 'నిష్ప్రయోజనం', 'ఇక సాగించలేకపోవడం', 'తీవ్ర అలసట', 'ఏమీ అనిపించకపోవడం', 'ఏడవడం', 'ఒంటరితనం', 'ఎవరూ పట్టించుకోకపోవడం', 'నాపై నాకే అసహ్యం',
    ]
    ...
    prompt_lines = [
        ...
        "built into SwaHealthy, a rural health app for users in Andhra Pradesh, India.",
        "",
        ...
        "- Respond ONLY in the same language the user writes in (Bengali, Hindi, or English,Telugu).",
